defmodule InnealWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "alert alert-dismissable rounded shadow-lg p-4 mb-4",
        @kind == :info && "bg-cyan-400",
        @kind == :error && "bg-red-400"
      ]}
      {@rest}
    >
      <p :if={@title} class="lead">
        <%= @title %>
      </p>
      <p><%= msg %></p>
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(InnealWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(InnealWeb.Gettext, "errors", msg, opts)
    # end
